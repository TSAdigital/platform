...
<div class="card">
    <div class="card-body">
        ...
        <div class="flex-grow-1">
            ...
            <?php if (Yii::$app->user->can('createPosition')) : ?>
        ...
        <?php Pjax::begin(['id' => 'pjax-position']); ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => array_intersect_key(Position::getStatusesArray(), array_flip(Position::getAvailableStatuses())),
                    'filterInputOptions' => [
                        'class' => 'form-select',
                    ],
                    'value' => function ($model) {
