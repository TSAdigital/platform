            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($model) {
                        return Html::a(Html::encode($model->description), ['view', 'name' => $model->name], ['data-pjax' => 0]);
                    },
                ],
                [
                    'attribute' => 'status',
                    ...
                    'filter' => array_intersect_key(AuthItem::getStatusesArray(), array_flip(AuthItem::getAvailableStatuses())),
                    'filterInputOptions' => [
                        'class' => 'form-select',
                    ],
                    'value' => function ($model) {
