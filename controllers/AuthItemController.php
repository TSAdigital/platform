...
class AuthItemController extends Controller
{
    ...
    {
        return [
            'Пользователи' => ['viewUserMenu', 'viewUserList', 'viewUser', 'createUser', 'updateUser', 'changePasswordUser', 'blockUser', 'unlockUser'],
            'Роли' => ['viewRoleMenu','viewRoleList', 'viewRole', 'createRole', 'updateRole', 'permissionUpdateRole', 'blockRole', 'unlockRole'],
        ];
    }
